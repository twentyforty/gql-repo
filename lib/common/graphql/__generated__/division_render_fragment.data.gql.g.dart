...
part of 'division_render_fragment.data.gql.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GDivisionRenderFragmentData>
    _$gDivisionRenderFragmentDataSerializer =
    new _$GDivisionRenderFragmentDataSerializer();

class _$GDivisionRenderFragmentDataSerializer
    implements StructuredSerializer<GDivisionRenderFragmentData> {
  @override
  ...
  @override
  final String wireName = 'GDivisionRenderFragmentData';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GDivisionRenderFragmentData object,
  ...
  @override
  GDivisionRenderFragmentData deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GDivisionRenderFragmentDataBuilder();
...
class _$GDivisionRenderFragmentData extends GDivisionRenderFragmentData {
  @override
  ...
  factory _$GDivisionRenderFragmentData(
          [void Function(GDivisionRenderFragmentDataBuilder)? updates]) =>
      (new GDivisionRenderFragmentDataBuilder()..update(updates))._build();

  _$GDivisionRenderFragmentData._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GDivisionRenderFragmentData', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(
        id, r'GDivisionRenderFragmentData', 'id');
    BuiltValueNullFieldError.checkNotNull(
        name, r'GDivisionRenderFragmentData', 'name');
    BuiltValueNullFieldError.checkNotNull(
        displayString, r'GDivisionRenderFragmentData', 'displayString');
    BuiltValueNullFieldError.checkNotNull(
        jurisdictionIds, r'GDivisionRenderFragmentData', 'jurisdictionIds');
  }

  @override
  GDivisionRenderFragmentData rebuild(
          void Function(GDivisionRenderFragmentDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GDivisionRenderFragmentDataBuilder toBuilder() =>
      new GDivisionRenderFragmentDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GDivisionRenderFragmentData &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GDivisionRenderFragmentData')
...
class GDivisionRenderFragmentDataBuilder
    implements
        Builder<GDivisionRenderFragmentData,
            GDivisionRenderFragmentDataBuilder> {
  _$GDivisionRenderFragmentData? _$v;
  ...
  GDivisionRenderFragmentDataBuilder() {
    GDivisionRenderFragmentData._initializeBuilder(this);
  }

  GDivisionRenderFragmentDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GDivisionRenderFragmentData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GDivisionRenderFragmentData;
  }

  @override
  void update(void Function(GDivisionRenderFragmentDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GDivisionRenderFragmentData build() => _build();

  _$GDivisionRenderFragmentData _build() {
    _$GDivisionRenderFragmentData _$result;
    try {
      _$result = _$v ??
          new _$GDivisionRenderFragmentData._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GDivisionRenderFragmentData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
