...
part of 'school_survey_fragment.data.gql.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GSchoolSurveyFragmentData> _$gSchoolSurveyFragmentDataSerializer =
    new _$GSchoolSurveyFragmentDataSerializer();

class _$GSchoolSurveyFragmentDataSerializer
    implements StructuredSerializer<GSchoolSurveyFragmentData> {
  @override
  ...
  @override
  final String wireName = 'GSchoolSurveyFragmentData';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GSchoolSurveyFragmentData object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.gradeLo,
          specifiedType: const FullType(_i1.GApiSchoolSurveyGradeLoChoices)),
      'gradeHi',
      serializers.serialize(object.gradeHi,
          specifiedType: const FullType(_i1.GApiSchoolSurveyGradeHiChoices)),
    ];
    Object? value;
  ...
  @override
  GSchoolSurveyFragmentData deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GSchoolSurveyFragmentDataBuilder();
      ...
      switch (key) {
        ...
        case 'gradeLo':
          result.gradeLo = serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i1.GApiSchoolSurveyGradeLoChoices))!
              as _i1.GApiSchoolSurveyGradeLoChoices;
          break;
        case 'gradeHi':
          result.gradeHi = serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i1.GApiSchoolSurveyGradeHiChoices))!
              as _i1.GApiSchoolSurveyGradeHiChoices;
          break;
        case 'teacherCount':
...
class _$GSchoolSurveyFragmentData extends GSchoolSurveyFragmentData {
  @override
  ...
  final double? lng;
  @override
  final _i1.GApiSchoolSurveyGradeLoChoices gradeLo;
  @override
  final _i1.GApiSchoolSurveyGradeHiChoices gradeHi;
  @override
  final int? teacherCount;
  @override
  final double? studentTeacherRatio;

  factory _$GSchoolSurveyFragmentData(
          [void Function(GSchoolSurveyFragmentDataBuilder)? updates]) =>
      (new GSchoolSurveyFragmentDataBuilder()..update(updates))._build();

  _$GSchoolSurveyFragmentData._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GSchoolSurveyFragmentData', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(
        surveyYear, r'GSchoolSurveyFragmentData', 'surveyYear');
    BuiltValueNullFieldError.checkNotNull(officeAddressStreet1,
        r'GSchoolSurveyFragmentData', 'officeAddressStreet1');
    BuiltValueNullFieldError.checkNotNull(officeAddressStreet2,
        r'GSchoolSurveyFragmentData', 'officeAddressStreet2');
    BuiltValueNullFieldError.checkNotNull(
        officeAddressCity, r'GSchoolSurveyFragmentData', 'officeAddressCity');
    BuiltValueNullFieldError.checkNotNull(
        officeAddressState, r'GSchoolSurveyFragmentData', 'officeAddressState');
    BuiltValueNullFieldError.checkNotNull(
        gradeLo, r'GSchoolSurveyFragmentData', 'gradeLo');
    BuiltValueNullFieldError.checkNotNull(
        gradeHi, r'GSchoolSurveyFragmentData', 'gradeHi');
  }

  @override
  GSchoolSurveyFragmentData rebuild(
          void Function(GSchoolSurveyFragmentDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GSchoolSurveyFragmentDataBuilder toBuilder() =>
      new GSchoolSurveyFragmentDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GSchoolSurveyFragmentData &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GSchoolSurveyFragmentData')
...
class GSchoolSurveyFragmentDataBuilder
    implements
        Builder<GSchoolSurveyFragmentData, GSchoolSurveyFragmentDataBuilder> {
  _$GSchoolSurveyFragmentData? _$v;
  ...
  _i1.GApiSchoolSurveyGradeLoChoices? _gradeLo;
  _i1.GApiSchoolSurveyGradeLoChoices? get gradeLo => _$this._gradeLo;
  set gradeLo(_i1.GApiSchoolSurveyGradeLoChoices? gradeLo) =>
      _$this._gradeLo = gradeLo;

  _i1.GApiSchoolSurveyGradeHiChoices? _gradeHi;
  _i1.GApiSchoolSurveyGradeHiChoices? get gradeHi => _$this._gradeHi;
  set gradeHi(_i1.GApiSchoolSurveyGradeHiChoices? gradeHi) =>
  ...
  GSchoolSurveyFragmentDataBuilder() {
    GSchoolSurveyFragmentData._initializeBuilder(this);
  }

  GSchoolSurveyFragmentDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GSchoolSurveyFragmentData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GSchoolSurveyFragmentData;
  }

  @override
  void update(void Function(GSchoolSurveyFragmentDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GSchoolSurveyFragmentData build() => _build();

  _$GSchoolSurveyFragmentData _build() {
    final _$result = _$v ??
        new _$GSchoolSurveyFragmentData._(
            G__typename: BuiltValueNullFieldError.checkNotNull(
                G__typename, r'GSchoolSurveyFragmentData', 'G__typename'),
            surveyYear: BuiltValueNullFieldError.checkNotNull(
                surveyYear, r'GSchoolSurveyFragmentData', 'surveyYear'),
            officeAddressStreet1: BuiltValueNullFieldError.checkNotNull(
                officeAddressStreet1, r'GSchoolSurveyFragmentData', 'officeAddressStreet1'),
            officeAddressStreet2: BuiltValueNullFieldError.checkNotNull(
                officeAddressStreet2, r'GSchoolSurveyFragmentData', 'officeAddressStreet2'),
            ...
            lat: lat,
            lng: lng,
            gradeLo: BuiltValueNullFieldError.checkNotNull(
                gradeLo, r'GSchoolSurveyFragmentData', 'gradeLo'),
            gradeHi: BuiltValueNullFieldError.checkNotNull(gradeHi, r'GSchoolSurveyFragmentData', 'gradeHi'),
